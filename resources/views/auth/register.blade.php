            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="cedula" class="col-md-4 col-form-label text-md-right">{{ __('Cédula de ciudadanía') }}</label>
                        ...
                        <div class="form-group row" hidden>
                            <div class="col-md-6">
                                <input id="admin" type="text" class="form-control" name="admin" value="0" required autocomplete="admin">
                            </div>
                        </div>
